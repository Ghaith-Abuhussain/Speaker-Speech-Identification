...
def extract_features(audio,rate):    
    ...
    mfcc_feature = preprocessing.scale( features.mfcc(audio,rate, winlen = 0.01,winstep = 0.005,numcep = 46,nfilt =48,nfft = 1200, appendEnergy = True,winfunc=np.hamming))  
